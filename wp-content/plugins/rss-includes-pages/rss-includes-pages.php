...
function rssip_action_links( $links ) {
   ...
   //$links[] = '<a href="http://infolific.com/technology/software-worth-using/include-pages-in-wordpress-rss-feeds/#pro-version" target="_blank">Pro Version</a> (less than $10)';
   return $links;
}
*/
...
function rssip_plugin_meta( $links, $file ) { // add some links to plugin meta row
	if ( strpos( $file, 'rss-includes-pages.php' ) !== false ) {
		...
		$links = array_merge( $links, array( '<a href="http://infolific.com/technology/software-worth-using/include-pages-in-wordpress-rss-feeds/#pro-version" target="_blank">Pro Version</a> (less than $10)' ) );
	}
	return $links;
}
